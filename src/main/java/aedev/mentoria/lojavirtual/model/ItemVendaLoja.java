...
@SequenceGenerator(name = "seq_item_loja_id", sequenceName = "seq_item_loja_id", allocationSize = 1, initialValue = 1)
public class ItemVendaLoja implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_item_loja_id")
	private Long id;
